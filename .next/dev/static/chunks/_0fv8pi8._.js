...
function MenuPage() {
    ...
    const [items, setItems] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(Object.entries(__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$defaultMenu$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DEFAULT_ITEMS"]).flatMap({
        "MenuPage.useState": ([category, values])=>values.map({
                "MenuPage.useState": (item, order)=>({
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "MenuPage.useEffect": ()=>{
            fetch("/api/menu", {
                ...
                "MenuPage.useEffect": (res)=>res.ok ? res.json() : Promise.reject(new Error())
            }["MenuPage.useEffect"]).then({
                "MenuPage.useEffect": (data)=>{
...
_s(MenuPage, "eXCo8tEsOXwEYsmgmp7LiXN18Bw=", false, function() {
    return [
...
//# sourceMappingURL=_0fv8pi8._.js.map
...
var __turbopack_async_dependencies__ = __turbopack_handle_async_dependencies__([
    __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$adminAuth$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__
]);
[__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$adminAuth$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__] = __turbopack_async_dependencies__.then ? (await __turbopack_async_dependencies__)() : __turbopack_async_dependencies__;
;
;
;
async function AdminDashboardLayout({ children }) {
    const session = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$adminAuth$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getAdminSession"])();
...
"[project]/app/admin/dashboard/layout.tsx [app-rsc] (ecmascript, Next.js Server Component)", (function(__turbopack_context__){
...
async function getSession() {
    ...
    try {
        const decoded = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$firebaseAdmin$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getAdminAuth"])().verifySessionCookie(sessionCookie, true);
        return {
            uid: decoded.uid,
...
async function getAdminSession() {
    ...
    const doc = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$firebaseAdmin$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getDb"])().collection("users").doc(session.uid).get();
    if (doc.data()?.role !== "admin") return null;
    return session;
}
__turbopack_async_result__();
} catch(e) { __turbopack_async_result__(e); } }, false);}),
"[project]/lib/firebaseAdmin.ts [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
//# sourceMappingURL=_0xd-ucc._.js.map
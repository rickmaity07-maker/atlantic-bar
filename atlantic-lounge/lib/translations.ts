...
interface Dictionary {
  ...
  cocktails: { eyebrow: string; title: string };
...
const de: Dictionary = {
    ...
    footer: {
      ...
      hoursLines: ["Di — Mi · 18 — 24 Uhr", "Do — Sa · 18 — 2 Uhr", "So · 17 — 22 Uhr", "Mo · Geschlossen"],
...
const en: Dictionary = {
    ...
    footer: {
      tagline: "Luxury Vibes & Premium Nights",
      hours: "Hours",
      hoursLines: ["Tue — Wed · 6 PM – 12 AM", "Thu — Sat · 6 PM – 2 AM", "Sun · 5 PM – 10 PM", "Mon · Closed"],
      visit: "Visit",
      follow: "Follow",

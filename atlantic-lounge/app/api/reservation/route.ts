...
export async function POST(req: NextRequest) {
  ...
  // Google/Facebook accounts must have completed phone verification before
  // they can book. Email/password accounts don't need this extra step.
  const signInProvider = decoded.firebase?.sign_in_provider;
  const isOAuthAccount = signInProvider === "google.com" || signInProvider === "facebook.com";

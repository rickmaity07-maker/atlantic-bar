    ...
    <footer className="relative bg-obsidian border-t border-gold/15 pt-16 pb-8">
      <div className="mx-auto max-w-7xl px-6 md:px-10 grid sm:grid-cols-2 md:grid-cols-4 gap-12">
        <div>
          ...
          <p className="font-script text-xl text-gold-bright mt-3">
            Luxury Vibes &amp; Premium Nights
          </p>
        </div>

        <div>
          <p className="text-[11px] tracking-[0.25em] uppercase text-gold-bright mb-4">Hours</p>
          <ul className="space-y-1.5 text-sm text-smoke">
            <li>Tue — Wed · 6 PM – 12 AM</li>
            <li>Thu — Sat · 6 PM – 2 AM</li>
            <li>Sun · 5 PM – 10 PM</li>
            <li>Mon · Closed</li>
          </ul>
        </div>

        <div>
          <p className="text-[11px] tracking-[0.25em] uppercase text-gold-bright mb-4">Visit</p>
          <ul className="space-y-1.5 text-sm text-smoke">
        ...
        <div>
          <p className="text-[11px] tracking-[0.25em] uppercase text-gold-bright mb-4">Follow</p>
          <ul className="space-y-1.5 text-sm text-smoke">
      ...
      <p className="text-center text-[11px] tracking-[0.15em] text-smoke/70 px-6">
        © {new Date().getFullYear()} Atlantic Lounge Bar. Design mock — for demonstration purposes only.
      </p>
    </footer>
  );
}

...
export default function About() {
  ...
  const STATS = [
    { n: "12", l: t.about.statYearsLabel },
    { n: "48", l: t.about.statPoursLabel },
    { n: "200", l: t.about.statSeatsLabel },
  ];
  return (
    <section id="about" className="relative bg-obsidian py-28 md:py-36">
      <div className="mx-auto max-w-7xl px-6 md:px-10 grid md:grid-cols-2 gap-14 md:gap-20 items-center">
        ...
        >
          ...
          >
            <p className="font-script text-3xl text-gold-bright">{t.about.est}</p>
            <p className="font-display text-2xl tracking-widest text-cream">2013</p>
          </motion.div>
        </motion.div>

        <div>
          <p className="font-script text-2xl md:text-3xl text-gold-bright/90 mb-1">{t.about.eyebrow}</p>
          <motion.h2
          ...
          >
            {t.about.titlePre} <span className="text-gold">{t.about.titleHighlight}</span>
          </motion.h2>
          <motion.p
            initial={{ opacity: 0 }}
